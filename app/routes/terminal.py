...
async def api_terminal(websocket: WebSocket):
    ...
    def _pty_child_setup():
        # Make the shell a session leader with this PTY as controlling TTY.
        # Without this, bash prints:
        ...
        try:
            ...
            # If tcsetpgrp fails, terminal still works; avoid crashing spawn.
            pass
